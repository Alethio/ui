            ...
            <HoverState>
                {(hover) =>
                    <IconButton {...otherProps} color={
                        theme => hover ?
                            (active ? theme.colors.button.primary.hover.background : theme.colors.toolbarIconHover) :
                            (active ? theme.colors.button.primary.normal.background : theme.colors.toolbarIcon)
                    } />
                }
            </HoverState>
        );
