...
let getIconSvg = (color: string | undefined) => `
<style type="text/css">
.st0{fill:${color || `url(#g)`};}
.st1{fill:${color || `url(#f)`};}
.st2{fill:${color || `url(#e)`};}
.st3{fill:${color || `url(#d)`};}
.st4{fill:${color || `url(#c)`};}
.st5{fill:${color || `url(#b)`};}
.st6{fill:${color || `url(#a)`};}
</style>
<linearGradient id="g" x1="168.05" x2="168.05" y1="2.1627" y2="364" gradientTransform="matrix(1 0 0 -1 0 364)" gradientUnits="userSpaceOnUse">
...
<linearGradient id="f" x1="292.09" x2="292.09" y1="355.48" y2="-.3744" gradientUnits="userSpaceOnUse">
    <stop stop-color="#283B62" offset=".15"/>
    <stop stop-color="#283B62" offset=".2483"/>
    <stop stop-color="#357CFF" offset=".5"/>
    <stop stop-color="#367FFC" offset=".5809"/>
    <stop stop-color="#388AF2" offset=".6483"/>
    <stop stop-color="#3B9BE2" offset=".7109"/>
    <stop stop-color="#3FB3CC" offset=".7704"/>
    <stop stop-color="#45D2AF" offset=".8274"/>
...
<linearGradient id="e" x1="271.12" x2="271.12" y1="355.48" y2="-.3744" gradientUnits="userSpaceOnUse">
    <stop stop-color="#283B62" offset=".15"/>
    <stop stop-color="#283B62" offset=".2483"/>
    <stop stop-color="#357CFF" offset=".5"/>
    <stop stop-color="#367FFC" offset=".5809"/>
...
<linearGradient id="d" x1="175.71" x2="175.71" y1="355.48" y2="-.3744" gradientUnits="userSpaceOnUse">
    <stop stop-color="#283B62" offset=".15"/>
    <stop stop-color="#283B62" offset=".2483"/>
    <stop stop-color="#357CFF" offset=".5"/>
    <stop stop-color="#367FFC" offset=".5809"/>
...
<linearGradient id="c" x1="154.74" x2="154.74" y1="355.48" y2="-.3744" gradientUnits="userSpaceOnUse">
    <stop stop-color="#283B62" offset=".15"/>
    <stop stop-color="#283B62" offset=".2483"/>
    <stop stop-color="#357CFF" offset=".5"/>
    <stop stop-color="#367FFC" offset=".5809"/>
...
<linearGradient id="b" x1="58.816" x2="58.816" y1="355.48" y2="-.3744" gradientUnits="userSpaceOnUse">
    <stop stop-color="#283B62" offset=".15"/>
    <stop stop-color="#283B62" offset=".2483"/>
    <stop stop-color="#357CFF" offset=".5"/>
    <stop stop-color="#367FFC" offset=".5809"/>
...
<linearGradient id="a" x1="37.844" x2="37.844" y1="355.48" y2="-.3744" gradientUnits="userSpaceOnUse">
    <stop stop-color="#283B62" offset=".15"/>
    <stop stop-color="#283B62" offset=".2483"/>
    <stop stop-color="#357CFF" offset=".5"/>
    <stop stop-color="#367FFC" offset=".5809"/>
...
export interface IAlethioReportsIconProps {
...
export class AlethioReportsIcon extends React.PureComponent<IAlethioReportsIconProps> {
    render() {
        return <SvgIconEncoded size={this.props.size} viewBoxSize={361.8}>
            {getIconSvg(this.props.color)}
        </SvgIconEncoded>;
    }
}
